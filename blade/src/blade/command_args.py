...
class CmdArguments(object):
    ...
    def __init__(self):
        ...
        actions = {
                  ...
                  'cleanup' : self._check_cleanup_command,
    ...
    def _check_cleanup_options(self):
        """check the cleanup options. """
        self._check_plat_and_profile_options()
        self._check_color_options()
    ...
    def _check_cleanup_command(self):
        """check cleanup options. """
        self._check_cleanup_options()
    ...
    def _add_cleanup_arguments(self, parser):
        """Add cleanup arguments for parser. """
        self.__add_plat_profile_arguments(parser)
        self.__add_generate_arguments(parser)
        self.__add_color_arguments(parser)
    ...
    def _cmd_parse(self):
        ...
        cleanup_parser = sub_parser.add_parser("cleanup",
                        help="Remove blade output:build64_debug, build64_release, blade-bin ccache-dir")
        ...
        self._add_cleanup_arguments(cleanup_parser)
